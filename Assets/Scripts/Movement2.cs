...
public class Movement2 : MonoBehaviour
{
    ...
    private bool canJump => Input.GetButtonDown("Jump2") && (onGround || onPlayer);
    ...
    {
        return new Vector2(Input.GetAxisRaw("Horizontal2"), Input.GetAxisRaw("Vertical")); //get input horizontal which unity assigns to A/D and left/right arrow keys
    }
